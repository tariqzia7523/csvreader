...
public class UpdateCsvFileLoader extends AsyncTaskLoader<String> {
    ...
    private String applyChanges() {
        ...
        if (mActionChangeData == Constants.ADD_ROW) {
            addRow(changedFile);
        } else if (mActionChangeData == Constants.DELETE_ROW) {
            deleteRow(changedFile);
        } else if (mActionChangeData == Constants.ADD_COLUMN) {
            addColumn(changedFile);
        } else if (mActionChangeData == Constants.DELETE_COLUMN) {
